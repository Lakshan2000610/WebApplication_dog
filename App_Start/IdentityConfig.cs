...
namespace WebApplication_dog
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<Contact> Contacts { get; set; } // Ensure this line is present
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        public static ApplicationSignInManager Create(IdentityFactoryOptions<ApplicationSignInManager> options, IOwinContext context)
        {
            ...
            var authenticationManager = context.Authentication; // Use context.Authentication instead of context.Get<IAuthenticationManager>()
